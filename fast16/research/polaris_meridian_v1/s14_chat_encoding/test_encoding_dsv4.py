...
def test_case_1():
    ...
    gold = open(os.path.join(TESTS_DIR, "test_output_1.txt")).read().removesuffix("\n")
...
def test_case_2():
    ...
    gold = open(os.path.join(TESTS_DIR, "test_output_2.txt")).read().removesuffix("\n")
    prompt = encode_messages(messages, thinking_mode="thinking")
    assert prompt == gold
...
def test_case_3():
    ...
    gold = open(os.path.join(TESTS_DIR, "test_output_3.txt")).read().removesuffix("\n")
...
def test_case_4():
    ...
    gold = open(os.path.join(TESTS_DIR, "test_output_4.txt")).read().removesuffix("\n")
