# Generate kaggle_colorlm.py notebook
import os
...
# Cell 2: VQ + Temperature + Student Model
CELLS.append(r"""
...
# Write file
output = '\n'.join(CELLS)
out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'kaggle_colorlm.py')
